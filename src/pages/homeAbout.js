  ...
  <div key={index} className="max-w-screen-sm mx-auto px-16 relative">
    <div className="flex items-start max-lg:items-center max-lg:flex-col gap-5 mt-10  ">
      ...
      {index !== menuItems.length - 1 && (
        <span className="relative after:w-[2px] after:h-[150px] after:bg-[#c19e46] after:absolute after:top-[110px] after:right-[70px] after:max-lg:right-[-3px] after:max-lg:top-[194px]  "></span>
      )}
      <div className="ml-2 relative max-lg:mt-0 ">
        ...
        <p className="text-start max-lg:text-center text-[#c19e46] text-lg font-medium mt-[-7px]  pt-7 cursor-pointer"><Link  to={item.href}  spy={true} smooth={true} ofsset={50} duration={500}>{item.content1}</Link></p>
      </div>
    </div>
